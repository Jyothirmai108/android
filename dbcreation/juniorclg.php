...
$sql = "INSERT INTO juniorclg(studentname, roll, aadhar, fathername, mobileno, stumobileno, dob, gender, school, marks, doj, cour, year, medium, community, phyhand, sports,  emailid, address, pin, pic) VALUES ('$studentname', '$roll', '$aadhar', '$fathername', '$mobileno', '$stumobileno', '$dob', '$gender', '$school', '$marks', '$doj', '$cour', '$year', '$medium', '$community', '$phyhand', '$sports',  '$emailid', '$address', '$pin', '$pic')";
